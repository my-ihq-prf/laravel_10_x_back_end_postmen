        ...
        <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
            <div>
                <div class="flex items-center">
                    <svg class="w-6 h-6 stroke-gray-400" fill="none" stroke-width="1.5" viewBox="0 0 24 24"
                ...
                <p class="mt-4 text-sm">
                    <a class="inline-flex items-center font-semibold text-indigo-700" href="https://laravel.com/docs">
                        Explore the documentation

                        <svg class="ml-1 w-5 h-5 fill-indigo-500" viewBox="0 0 20 20"
                             xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
                ...
                <p class="mt-4 text-sm">
                    <a class="inline-flex items-center font-semibold text-indigo-700" href="https://laracasts.com">
